...
## 사용 스택
프로젝트 기간이 5주였기에 생산성에 초점을 맞추고 기술 스택을 선정하였습니다.

#### [FE] **React**
선정 이유
1. 스토리를 즐기는 플랫폼이기에 높은 사용자 경험을 위해 SPA 라이브러리/프레임워크 고려
2. 팀 구성원 모두 SPA 기반 지식이 없었기에 가장 커뮤니티가 큰 React 선정

#### [BE] **Node.js**
선정 이유
1. Node를 사용하면 JavaScript만을 사용해서 서버 로직을 개발할 수 있어 생산성을 높임
2. npm을 이용해 협업 시 버전 관리 용이
3. 논블로킹 방식으로 그림과 음악 파일들에 대해 효율적인 I/O 처리
